...
EntityPlayer = ig.Entity.extend({
	...
	startTeleport: function() {
		...
		ig.game.fadeToTint(150, 150, 150, 1 * this.teleportSlowdown);
	},
	...
	endTeleport: function() {
		...
		if (ig.input.state('right') || ig.input.state('left') ||
				ig.input.state('up') || ig.input.state('down')) {
			this.slowTimer.reset()	
		}

		ig.game.fadeIn(1 * this.teleportSlowdown);
	},
