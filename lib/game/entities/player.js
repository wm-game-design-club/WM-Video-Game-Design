...
EntityPlayer = ig.Entity.extend({
    ...
    normalImage:   new ig.Image('media/mario_small.gif'),
    hologramImage: new ig.Image('media/mario_hologram.gif'),
	...
	draw: function() {
		...
		if (ig.global.wm || this.invincibilityTimer.delta() > 0 || this.invincibilityFrame) {
            ...
            if (this.isTeleporting) {
                ...
                this.currentAnim.draw(this.teleportPos.x - ig.game._rscreen.x,
                                      this.teleportPos.y - ig.game._rscreen.y)
