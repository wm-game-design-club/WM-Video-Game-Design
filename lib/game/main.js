...
MyGame = ig.Game.extend({
    ...
    var planetA_happy_intro = new ig.Sound('media/music/planetA_happy_intro.mp3',false);
    var planetA_happy_loop = new ig.Sound('media/music/planetA_happy_loop.mp3',false);
    ig.music.add(planetA_happy_intro,'planetA_happy_intro');
    ig.music.add(planetA_happy_loop, 'planetA_happy_loop');
