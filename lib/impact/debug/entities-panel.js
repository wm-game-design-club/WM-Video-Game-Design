...
ig.Entity.inject({
	...
	draw: function() {
		...
		if(ig.Entity._debugSight && this instanceof EntityEnemyPursuer) {
			...
			if (trace.collision.x || trace.collision.y || trace.collision.slope) this._debugDrawLine( this.colors.boxes, x, y, trace.pos.x, trace.pos.y );
			else this._debugDrawLine( this.colors.velocities, x, y, x2, y2 );
		}
	},
