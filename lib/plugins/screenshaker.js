...
*
*
*       DOCUMENTATION: https://github.com/killbot/Impactjs_screenshaker/wiki/How-To-Make-It-Go
*
*
1. inside init() create an instance of the ScreenShaker:
    this.screenShaker = new ScreenShaker();
2. inside update() add the screenshaker update method:
    this.screenShaker.update();
3.  and then add the shaking method below it:
    this.screenShaker.shakeScreen(this.screen); (this.screen refers to ig.game.screen).
*
*
*    API
*   ----
